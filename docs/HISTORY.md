...
The sleep/wake display issue is the one known remaining problem. The touchscreen also works — confirmed. The fingerprint reader does not; Validity Inc. scanner, no macOS driver.
